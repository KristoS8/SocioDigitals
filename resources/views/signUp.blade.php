...
<body>
    ...
    <h1 class="text-2xl font-bold max-w-sm mx-auto my-10">Daftar Akun Anda Sebagai Peminjam (Borrower)</h1>
    <form class="max-w-sm mx-auto" method="POST" action="/signUp/store">
        @csrf
        <div class="mb-5">
